    ...
    return [
        ...
        'services' => [
            'items' => [
                ...
                '3' => ['title' => __('Первая сессия по специальной цене', 'eot-theme')],
            ],
        ],
        'booking' => [
        ...
        'schema' => [
            ...
            'offers' => [
                ...
                [
                    'name' => __('Первая сессия по специальной цене', 'eot-theme'),
                    'description' => __('На первой встрече мы познакомимся, проясним ваш запрос и проведём полноценную часовую сессию с опорой на эмоционально-образную терапию. Стоимость первой встречи — 30 € вместо обычных 60 €. Последующие индивидуальные сессии — 60 € / час.', 'eot-theme'),
                    'price' => '30',
                    'currency' => 'EUR',
                ],
            ],
...
function eot_get_sk_translations() {
    return [
        ...
        // Услуга "Первая сессия" (бывшая "Вводная встреча") - заголовок, длительность и описание карточки/выпадашки
        'Первая сессия по специальной цене' => 'Prvé sedenie za špeciálnu cenu',
        '1 час' => '1 hodina',
        'На первой встрече мы познакомимся, проясним ваш запрос и проведём полноценную часовую сессию с опорой на эмоционально-образную терапию. Стоимость первой встречи — 30 € вместо обычных 60 €. Последующие индивидуальные сессии — 60 € / час.' => 'Na prvom stretnutí sa zoznámime, ujasníme si vašu požiadavku a uskutočníme plnohodnotné hodinové sedenie s oporou o emocionálno-obrazovú terapiu. Cena prvého stretnutia je 30 € namiesto bežných 60 €. Nasledujúce individuálne sedenia — 60 € / hodina.',

        // Услуга "Индивидуальная сессия" - цена с указанием "в час"
        '€60 в час' => '€60 za hodinu',
