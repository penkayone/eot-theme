...
<main>
  <section class="section">
    <div class="container">
      <h1><?php echo esc_html(eot_translate('Соц.сети')); ?></h1>
      <div class="contacts-v2-grid">
        <article class="card contacts-v2-social">
          <div class="contacts-social-strip">
            <a class="btn btn-social social-telegram" href="https://t.me/LaraLorein" target="_blank" rel="noopener noreferrer" aria-label="<?php echo esc_attr(eot_translate('Telegram')); ?>">
              <img class="social-icon" src="<?php echo eot_image_url('icon-telegram.svg'); ?>" alt="" aria-hidden="true" />
              <span><?php echo esc_html(eot_translate('Telegram')); ?></span>
            </a>
            <a class="btn btn-social social-instagram" href="https://www.instagram.com/larisamomotova?utm_source=qr&igsh=ajR4dWpsMDJ2cHFw" target="_blank" rel="noopener noreferrer" aria-label="<?php echo esc_attr(eot_translate('Instagram')); ?>">
              <img class="social-icon" src="<?php echo eot_image_url('icon-instagram.svg'); ?>" alt="" aria-hidden="true" />
              <span><?php echo esc_html(eot_translate('Instagram')); ?></span>
            </a>
            <a class="btn btn-social social-youtube" href="https://youtube.com/@larysamomotova?si=Czm1zGo4rbFc5QG-" target="_blank" rel="noopener noreferrer" aria-label="<?php echo esc_attr(eot_translate('YouTube')); ?>">
              <img class="social-icon" src="<?php echo eot_image_url('icon-youtube.svg'); ?>" alt="" aria-hidden="true" />
              <span><?php echo esc_html(eot_translate('YouTube')); ?></span>
            </a>
            <a class="btn btn-social social-facebook" href="https://www.facebook.com/share/17xxhgL4zL/" target="_blank" rel="noopener noreferrer" aria-label="<?php echo esc_attr(eot_translate('Facebook')); ?>">
              <img class="social-icon" src="<?php echo eot_image_url('icon-facebook.svg'); ?>" alt="" aria-hidden="true" />
              <span><?php echo esc_html(eot_translate('Facebook')); ?></span>
            </a>
          </div>
        </article>

        <article class="card booking-v2 booking-v2-full" id="booking">
          <h2><?php echo esc_html(eot_translate('Запись на консультацию')); ?></h2>
          <div class="booking-v2-controls">
            <div class="booking-v2-field">
              <span><?php echo esc_html(eot_translate('Выберите услугу')); ?></span>
              <div class="booking-v2-select-wrap">
                <button type="button" id="service-trigger" class="booking-v2-select-trigger" aria-haspopup="listbox" aria-expanded="false">
                  <?php echo esc_html(eot_translate('Выберите услугу')); ?>
                </button>
          ...
          <div class="booking-v2-slots">
            <h3 class="booking-v2-subtitle"><?php echo esc_html(eot_translate('Доступное время')); ?></h3>
